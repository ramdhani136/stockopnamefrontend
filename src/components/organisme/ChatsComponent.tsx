...
const ChatsComponent: React.FC = () => {
  ...
  return (
    <div
      ref={modalRef}
      className={`border  h-[420px] absolute bg-white z-[300]   duration-300 rounded-t-lg shadow-md flex flex-col ${
        open
          ? "bottom-0 w-[320px] right-[20px]"
          : "-bottom-[385px] w-[230px] right-[5px]"
      }`}
    >
      <div
        className={`${
