...
const HeaderComponent: React.FC = () => {
  return (
    <div className="bg-white w-full h-auto py-3 pl-1 border-b flex flex-row sticky top-0 z-[51]  justify-end lg:justify-between  px-6 items-center  drop-shadow-sm">
